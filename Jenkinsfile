pipeline {
	...
	environment {		
		GITHUB_URL ='https://github.com/microchip-pic-avr-examples/attiny817-realistic-heartbeat-led-cip-video-series-studio.git'
		BITBUCKET_URL = 'https://bitbucket.microchip.com/scm/ebe/attiny817-realistic-heartbeat-led-cip-video-series-studio.git'
